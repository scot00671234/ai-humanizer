...
export default function BlogArticlePage() {
  ...
  const jsonLd = useMemo(() => {
    ...
    return {
      ...
      author: { '@type': 'Organization', name: 'Humanizer AI' },
      publisher: { '@type': 'Organization', name: 'Humanizer AI' },
  ...
  useEffect(() => {
    if (!article) return
    setSeoMeta({
      title: `${article.title} | Humanizer AI Blog`,
      description: article.metaDescription,
        ...
        <footer className="blogArticleFooter">
          <p className="blogCta">
            ...
            <Link to="/register" className="blogCtaLink">
              Get started free on Humanizer AI
            </Link>
          </p>
