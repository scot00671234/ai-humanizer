    ...
    <div className="dashboardPage dashboardPageOverview">
      ...
      <div className="dashboardCard dashboardOverviewCard">
        <p className="dashboardCardText">
          Go to <Link to="/dashboard/resume" className="dashboardCardLink">Resume</Link> to paste your resume, add a job description, rewrite bullets with AI, get an ATS score, and export a clean PDF.
        </p>
      </div>
    </div>
  )
