> **Archived:** Original resume-builder MVP product design (pre–AI humanizer pivot).  
> Current docs: [../PRODUCT_AI_HUMANIZER.md](../PRODUCT_AI_HUMANIZER.md), [../AI_HUMANIZER_ROADMAP.md](../AI_HUMANIZER_ROADMAP.md).
